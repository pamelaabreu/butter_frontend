...
UserService.getUsersInfo = (dbUsername) => {
    ...
    const getFollowers = getUserData.then(({id}) => axios.get(`${dbConnect}/follow/${id}/readAllFollowers`).then(res => res.data))
    
    const getFollowings = getUserData.then(({id}) => axios.get(`${dbConnect}/follow/${id}/readAllFollowings`).then(res => res.data))

    const getAllPosts = getUserData.then(({id}) => axios.get(`${dbConnect}/post/all/${id}`).then(res => res.data))
